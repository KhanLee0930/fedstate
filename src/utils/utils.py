...
def parse_args():
    ...
    # Critic Parameters
    argparser.add_argument("--num-samples", type=int, default=1, help="Number of samples to estimate parameters")
...
def run_pre_experiments(p, B, alpha, num_samples, initial_model, criterion, save_dir, device):
    ...
    zeta = sorted_eigenvalues[1] # Second largest eigenvalue, which is zero when graoh is fully connected
