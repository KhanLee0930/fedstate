...
def Model_Generator(N, M, D, delta, K):
    ...
    fileName = open("/home/svu/e1310988/fl/fedsate/src/StarlinkDataForFL/StarLink_OneShell_1200Slots_Step5s.pkl", "rb")
    orb_period = 1200
    altitude = 540 # 540 km
    Lat_list = []
    Lon_list = []
    ...
    file_write = open("/home/svu/e1310988/fl/fedsate/src/StarlinkDataForFL/SatelliteRelatedData.pkl", "wb")
    data = {'Psi':Psi,
            'Phi':Phi,
            'C_access':C_access,
            'C_e':C_e,
